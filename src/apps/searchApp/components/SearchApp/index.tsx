      ...
      <div className={styles.reviewList}>
        <div className={styles.reviewCard}>
          <div className={styles.postHeader}>
            <span className={styles.postNumber}>132</span>
            <span className={styles.postName}>本当にあった怖い名無し</span>
            <span className={styles.postDate}>2009/12/03(木) 03:48:38</span>
            <span className={styles.postId}>ID:i8XtSQs10</span>
          </div>
          <div className={styles.content}>{text}</div>
        </div>
        <div className={styles.reviewCard}>
          <div className={styles.postHeader}>
            <span className={styles.postNumber}>573</span>
            <span className={styles.postName}>
              以下、名無しにかわりましてVIPがお送りします
            </span>
            <span className={styles.postDate}> 2012/06/18(月) 23:47:12</span>
            <span className={styles.postId}>ID:MNO4567890</span>
          </div>
          <div className={styles.content}>{hoge}</div>
        </div>
        <div className={styles.reviewCard}>
          <div className={styles.postHeader}>
            <span className={styles.postNumber}>251</span>
            <span className={styles.postName}>
              以下、名無しにかわりましてVIPがお送りします
            </span>
            <span className={styles.postDate}>2005/09/22(木) 14:28:55</span>
            <span className={styles.postId}>ID:PQR7890123</span>
          </div>
          <div className={styles.content}>{fuga}</div>
        </div>
      </div>
    </div>
  );
